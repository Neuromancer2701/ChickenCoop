...
$$.onSuccess_anon = {"": "Closure;canvas_0,data_1",
  call$0: function() {
    var t1, t2, width, height, radius, t3, bottom, t4, percent, context, t5, level_string;
    t1 = this.canvas_0;
    t2 = t1.get$width();
    width = $.getInterceptor$JSNumber(t2).operator$div$1(t2, 2);
    height = t1.get$height();
    t2 = $.getInterceptor$JSNumber(width);
    radius = t2.operator$mul$1(width, 0.9);
    t3 = $.getInterceptor$JSNumber(height);
    bottom = t3.operator$sub$1(height, width);
    t4 = this.data_1;
    t4 = $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, "Water Level");
    percent = $.getInterceptor$JSNumber(t4).operator$div$1(t4, 100);
    context = t1.get$context2d();
    context.clearRect$4(0, 0, t1.get$width(), t1.get$height());
    context.set$lineWidth(2);
    context.set$fillStyle("blue");
    context.set$strokeStyle("black");
    context.beginPath$0();
    context.arc$6(width, bottom, radius, 3.141592653589793, 6.283185307179586, true);
    if (!$.eqB(percent, 0))
      context.fill$0();
    context.arc$6(width, width, radius, 0, 3.141592653589793, true);
    if ($.eqB(percent, 1))
      context.fill$0();
    context.closePath$0();
    context.stroke$0();
    t1 = t2.operator$sub$1(width, radius);
    t4 = $.getInterceptor$JSNumber(radius).operator$mul$1(radius, 2);
    t5 = $.getInterceptor$JSNumber(bottom).operator$sub$1(bottom, width);
    t5 = $.getInterceptor$JSNumber(t5).operator$mul$1(t5, percent);
    context.fillRect$4(t1, bottom, t4, $.getInterceptor$JSNumber(t5).operator$negate$0(t5));
    if ($.gtB(percent, 0.5)) {
      context.set$fillStyle("white");
      context.set$textBaseline("top");
    } else {
      context.set$fillStyle("blue");
      context.set$textBaseline("bottom");
    }
    context.set$font("15px Lucida Console");
    t1 = $.getInterceptor$JSNumber(percent).operator$mul$1(percent, 100);
    t1 = $.getInterceptor$JSNumber(t1).toInt$0(t1);
    level_string = $.S($.getInterceptor(t1).toString$0(t1)) + "%";
    t2 = t2.operator$sub$1(width, radius);
    context.fillText$3(level_string, $.getInterceptor$JSNumber(t2).operator$add$1(t2, 2), t3.operator$div$1(height, 2));
  }
};
...
$$.MutationObserver_observe_anon = {"": "Closure;parsedOptions_0",
  call$2: function(k, v) {
    if ($.CONSTANT4.containsKey$1(k) === true)
...
$.main = function() {
  $.Timer_Timer$repeating(1000, $.OpenData);
};

$.OpenData = function(T) {
  $.HttpRequest_HttpRequest$get("data.json", $.onSuccess);
};

$.onSuccess = function(req) {
  var Temperature, DoorStatus, Time, canvas, data, t1;
  Temperature = document.query$1("#Temp");
  DoorStatus = document.query$1("#Door");
  Time = document.query$1("#Time");
  canvas = document.query$1("#container");
  data = $.parse(req.get$responseText(), null);
  t1 = $.getInterceptor$JSStringJSArray(data);
  Temperature.set$text("Temperature: " + $.S(t1.operator$index$1(data, "Temperature")) + " Degrees");
  if (t1.operator$index$1(data, "Door Open") === true)
    DoorStatus.set$text("Door: Open");
  else
    DoorStatus.set$text("Door: Closed");
  Time.set$text("Uptime: " + $.S(t1.operator$index$1(data, "Time")) + " Seconds");
  window.requestLayoutFrame$1(new $.onSuccess_anon(canvas, data));
};
...
$.CONSTANT8 = Isolate.makeConstantList(["childList", "attributes", "characterData", "subtree", "attributeOldValue", "characterDataOldValue"]);
$.CONSTANT4 = new Isolate.$isolateProperties.ConstantMap(6, {childList: true, attributes: true, characterData: true, subtree: true, attributeOldValue: true, characterDataOldValue: true}, Isolate.$isolateProperties.CONSTANT8);
...
// 19 !leaf
(function() {
  var v0_Uint8Array = "Uint8Array|Uint8ClampedArray", v1_MediaElement = "HTMLMediaElement|HTMLVideoElement|HTMLAudioElement", v2_SvgElement = "SVGElement|SVGAElement|SVGAltGlyphDefElement|SVGTextContentElement|SVGTextPositioningElement|SVGAltGlyphElement|SVGTRefElement|SVGTSpanElement|SVGTextElement|SVGTextPathElement|SVGAltGlyphItemElement|SVGAnimationElement|SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGSetElement|SVGCircleElement|SVGClipPathElement|SVGCursorElement|SVGDescElement|SVGEllipseElement|SVGFEBlendElement|SVGComponentTransferFunctionElement|SVGFEFuncAElement|SVGFEFuncBElement|SVGFEFuncGElement|SVGFEFuncRElement|SVGFECompositeElement|SVGDefsElement|SVGFEDisplacementMapElement|SVGFEConvolveMatrixElement|SVGFEDiffuseLightingElement|SVGFEComponentTransferElement|SVGFEDropShadowElement|SVGFEGaussianBlurElement|SVGFEMorphologyElement|SVGFEColorMatrixElement|SVGFEFloodElement|SVGFESpotLightElement|SVGFEMergeElement|SVGFETurbulenceElement|SVGFEDistantLightElement|SVGFEOffsetElement|SVGFontFaceFormatElement|SVGFESpecularLightingElement|SVGFEMergeNodeElement|SVGFontFaceUriElement|SVGFontFaceNameElement|SVGFEPointLightElement|SVGFEImageElement|SVGGlyphElement|SVGGElement|SVGFontFaceElement|SVGHKernElement|SVGGlyphRefElement|SVGFETileElement|SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement|SVGFilterElement|SVGFontFaceSrcElement|SVGMarkerElement|SVGImageElement|SVGMetadataElement|SVGMissingGlyphElement|SVGMPathElement|SVGLineElement|SVGMaskElement|SVGFontElement|SVGPathElement|SVGForeignObjectElement|SVGPatternElement|SVGPolygonElement|SVGPolylineElement|SVGRectElement|SVGScriptElement|SVGStopElement|SVGStyleElement|SVGSymbolElement|SVGSVGElement|SVGTitleElement|SVGUseElement|SVGVKernElement|SVGViewElement|SVGSwitchElement", v3_Element = [v1_MediaElement, v2_SvgElement, "Element|HTMLScriptElement|HTMLSelectElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|HTMLAppletElement|HTMLBaseFontElement|HTMLDirectoryElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLMarqueeElement|HTMLElement|HTMLAnchorElement|HTMLAreaElement|HTMLBRElement|HTMLBaseElement|HTMLBodyElement|HTMLButtonElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFormElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement"].join("|"), v4_DocumentFragment = "DocumentFragment|ShadowRoot", v5_CharacterData = "CharacterData|Text|CDATASection|Comment", v6_Document = "Document|SVGDocument|HTMLDocument", v7_Node = [v3_Element, v4_DocumentFragment, v5_CharacterData, v6_Document, "Node|Attr|DocumentType|EntityReference|Notation|ProcessingInstruction"].join("|");
  $.dynamicSetMetadata([["Uint8Array", v0_Uint8Array], ["ArrayBufferView", [v0_Uint8Array, "ArrayBufferView"].join("|")], ["HTMLCollection", "HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection"], ["Blob", "Blob|File"], ["CharacterData", v5_CharacterData], ["HTMLMediaElement", v1_MediaElement], ["Document", v6_Document], ["DocumentFragment", v4_DocumentFragment], ["SVGElement", v2_SvgElement], ["Element", v3_Element], ["Node", v7_Node], ["NodeList", "NodeList|RadioNodeList"], ["EventTarget", [v7_Node, "EventTarget|DOMWindow|XMLHttpRequest|XMLHttpRequestUpload"].join("|")]]);
})();
...
//@ sourceMappingURL=chickencoop.dart.js.map